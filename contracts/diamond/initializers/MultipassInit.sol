...
import {LibEIP712WithStorage} from "../libraries/LibEIP712WithStorage.sol";
import "@openzeppelin/contracts/utils/cryptography/ECDSA.sol";
import "../OnlyOwnerDiamond.sol";
...
contract MultipassInit is OnlyOwnerDiamond {
    ...
    function init(string memory name, string memory version) onlyOwner  public {
