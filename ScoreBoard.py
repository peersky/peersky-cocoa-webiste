...
class ScoreBoard:
    ...
    def index(self, arg1: ChecksumAddress) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.index.call(arg1)
    ...
    def register_participant(
        self, new_participant_address: ChecksumAddress, transaction_config
    ) -> Any:
        self.assert_contract_is_instantiated()
        return self.contract.registerParticipant(
            new_participant_address, transaction_config
        )
...
def handle_index(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = ScoreBoard(args.address)
    result = contract.index(arg1=args.arg1)
    print(result)
...
def handle_register_participant(args: argparse.Namespace) -> None:
    ...
    result = contract.register_participant(
        new_participant_address=args.new_participant_address,
        transaction_config=transaction_config,
    )
    print(result)
...
def generate_cli() -> argparse.ArgumentParser:
    ...
    add_default_arguments(index_parser, False)
    index_parser.add_argument("--arg1", required=True, help="Type: address")
    ...
    register_participant_parser.add_argument(
        "--new-participant-address", required=True, help="Type: address"
    )
