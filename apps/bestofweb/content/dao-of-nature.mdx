...
Some of these issues were covered in a recent OpenZeppelins blog post on Progressive Decentralization [[7]](https://www.google.com/search?client=safari&rls=en&q=openZeppelin+progrssive+decentralzation&ie=UTF-8&oe=UTF-8)
