...
# Role based Access for Ethereum
...
By adapting existing standards as RBAC, now each token ID becomes an unique `Role` what will be able to access method with eligible signature!
